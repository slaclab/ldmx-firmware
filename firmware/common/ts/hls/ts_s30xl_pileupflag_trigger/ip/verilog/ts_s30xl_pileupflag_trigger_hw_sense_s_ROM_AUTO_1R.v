...
// ==============================================================
`timescale 1 ns / 1 ps
module ts_s30xl_pileupflag_trigger_hw_sense_s_ROM_AUTO_1R (
    address0, ce0, q0, 
    address1, ce1, q1, 
    address2, ce2, q2, 
    address3, ce3, q3, 
...
initial begin
    ...
    $readmemh("./ts_s30xl_pileupflag_trigger_hw_sense_s_ROM_AUTO_1R.dat", rom0); 
    $readmemh("./ts_s30xl_pileupflag_trigger_hw_sense_s_ROM_AUTO_1R.dat", rom1); 
    $readmemh("./ts_s30xl_pileupflag_trigger_hw_sense_s_ROM_AUTO_1R.dat", rom2); 
    $readmemh("./ts_s30xl_pileupflag_trigger_hw_sense_s_ROM_AUTO_1R.dat", rom3); 
    $readmemh("./ts_s30xl_pileupflag_trigger_hw_sense_s_ROM_AUTO_1R.dat", rom4); 
    $readmemh("./ts_s30xl_pileupflag_trigger_hw_sense_s_ROM_AUTO_1R.dat", rom5);
end
