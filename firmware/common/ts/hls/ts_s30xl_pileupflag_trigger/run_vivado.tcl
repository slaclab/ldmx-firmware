...
set ip_vlnv xilinx.com:hls:ts_s30xl_pileupflag_trigger_hw:1.0
set ip_repo_path ../ip
...
dict set report_options hls_project ts_s30xl_pileupflag_trigger
