...
#Clocks
create_clock -period 3.2 -name pgpRefClk [get_ports pgpRefClkP]


create_clock -period 3.810 -name adcDClk[0] [get_ports {adcDClkP[0]}]
create_clock -period 3.810 -name adcDClk[1] [get_ports {adcDClkP[1]}]
create_clock -period 3.810 -name adcDClk[2] [get_ports {adcDClkP[2]}]
create_clock -period 3.810 -name adcDClk[3] [get_ports {adcDClkP[3]}]
create_clock -period 3.810 -name adcDClk[4] [get_ports {adcDClkP[4]}]
create_clock -period 3.810 -name adcDClk[5] [get_ports {adcDClkP[5]}]
create_clock -period 3.810 -name adcDClk[6] [get_ports {adcDClkP[6]}]
create_clock -period 3.810 -name adcDClk[7] [get_ports {adcDClkP[7]}]

set_input_jitter adcDClk[0] .35
create_generated_clock -name adcBitClkDiv4[0] [get_pins {FebCore_1/HYBRIDS_GEN[0].HybridIoCore_1/AdcReadout_1/U_AdcBitClkR/O}]
...
set apvClkPin [get_pins {FebCore_1/DaqTiming_1/r_reg[daqClkDiv3]/Q}]
create_generated_clock -name apvClk -source ${daqClkPin} -edges {1 3 7} \
    ${apvClkPin}
